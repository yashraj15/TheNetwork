    ...
    <div class='st-content-inner'>
      <div class='container'>
        <div class='cover profile'>
          <div class='image'>
            <img src='images/${requestScope.searchedUser.coverPic}' style="width:1138px;height:300px;" />

          </div>
      <div class='cover-info'>
        <div class='avatar'>
       <img src='images/${requestScope.searchedUser.profilePic}' />
        </div>
        <div class='name'><a href='#'>${requestScope.searchedUser.fullName}</a></div>
        <ul class='cover-nav'>
          <li class='active'><a href='PublicAbout.jsp?searchedUser=${requestScope.searchedUser.userEmail}'><i class=''></i> My Profile</a></li>
          <li><a href='PublicTimeline.jsp?searchedUser=${requestScope.searchedUser.userEmail}'><i class=''></i> Feed</a></li>
          <li><a href='PublicFriends.jsp?searchedUser=${requestScope.searchedUser.userEmail}'><i class=''></i> Friends</a></li>
          <li><a href='PublicEvents.jsp?searchedUser=${requestScope.searchedUser.userEmail}'><i class='fa '></i> Posts</a></li>
		      
        </ul>
<%

if(searchedUser.email.equals(user.email))
{%>
...
%>
          ...
          <input type='hidden' name='hiddenFriendName' value='${requestScope.searchedUser.userEmail}'>
          </form>
<%
        }
                  ...
                  <div class='panel panel-default profile-card clearfix-xs'>
                    <div class='panel-body'>
                      ...
                      <ul class='icon-list icon-list-block'>
                       <li><i>College:</i>${requestScope.searchedUser.userUniversity}</li>
                        <li><i>City:</i>${requestScope.searchedUser.userCity}</li>
                        <li><i>Major:</i>${requestScope.searchedUser.userMajor}</li>
                        <li><i>Graduation Date:</i>${requestScope.searchedUser.leavingDate}</li>
                      </ul>
                    </div>
                  </div>
                </div>
                ...
                <div class='timeline-block'>
                  <div class='panel panel-default profile-card clearfix-xs'>
                    <div class='panel-body'>
                      ...
                      <ul class='icon-list icon-list-block'>
                       <li><i>Date of Birth:</i>${requestScope.searchedUser.userDOB}</li>
                        <li><i>Gender:</i>${requestScope.searchedUser.userGender}</li>
                        <li><i>Phone Number:</i>${requestScope.searchedUser.userPhone}</li>
                        <li><i>Email:</i>${requestScope.searchedUser.userEmail}</li>
                      </ul>
                    </div>
                  </div>
                </div>
