...
<%
      ...
      if(session!=null)
      {
        ...
        statusList = MySqlDataStoreUtilities.getUserStatus(searchedUserEmail);
...
%>
    ...
    <li class='dropdown'>
              ...
              <div class='cover-info'>
               ...
               <img src='images/<%= searchedUser.profilepic %>' />
                ...
                <ul class='cover-nav'>
                  ...
                  <li class='active'><a href='PublicTimeline.jsp?searchedUser=<%= searchedUser.email %>'><i class=''></i> Feed</a></li>
                  <li><a href='PublicFriends.jsp?searchedUser=<%= searchedUser.email %>'><i class=''></i> Friends</a></li>
                  <li><a href='PublicEvents.jsp?searchedUser=<%= searchedUser.email %>'><i class=''></i> Posts</a></li>
      ...
      <td>
                  ...
                  <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                      <div class="media">
                        <div class="media-left">
                          <a href="">
                            <img src="images/<%= searchedUser.profilepic %>" height="50" width="50" class="media-object">
                          </a>
                        </div>
                        <div class="media-body">

                          <a href=""><%= searchedUser.name %></a>
                    ...
                    <div class="view-all-comments">
                      ...
                      <% commentList = MongoDBDataStoreUtilities.getComments(searchedUser.email, statusList.get(i).status);%>
                      <span> <%=commentList.size()%> comments</span>
                    </div>
                    <form id='upload' action="InsertCommentServlet?searchedUser=<%= searchedUser.email %>" method="post">
                ...
                <input name="comment" type="text" style="height:36px;width:459px"/><button type='submit'  href='#' class='btn btn-primary btn-xs pull-right display-none' style="display:block;height:35px;">Post</button>
