...
public class MySqlDataStoreUtilities
{
    ...
    public static void getConnection()
    {
        try
        {
            ...
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/NetworkDatabase"
            ,"root","root");
        }
        catch(Exception e){
            e.printStackTrace();
...
return statusList;
  ...
  public static void updateUser(User user){
      ...
      String accessSpecifier = null;
  		try {
  			Class.forName("com.mysql.jdbc.Driver").newInstance();
  			conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/NetworkDatabase", "root", "root");
  	...
  	public static String updateUserProfilePicture(String fileName, User user) {
  		try {
  			Class.forName("com.mysql.jdbc.Driver").newInstance();
  			con = DriverManager.getConnection("jdbc:mysql://localhost:3306/NetworkDatabase", "root", "root");
