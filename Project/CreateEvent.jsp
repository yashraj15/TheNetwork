               ...
               <img src='images/<%= user.profilepic %>' />
                ...
                <ul class='cover-nav'>
                  ...
                  <li><a href='PrivateFriends.jsp'><i class=''></i> Friends</a></li>
		              <li class='active'><a href='PrivateEvents.jsp'><i class=''></i> Posts</a></li>
                 
				</ul>
              </div>
            </div>

			<div class="col-xs-12 col-md-6 col-lg-4 item" style="width:1140px; background-color:white">
			  ...
			  <ul class="icon-list icon-list-block">
					<form method="post" action="EventsCreate.jsp">
                      <input name='EventName' class='form-control share-text' type="text" placeholder='Name of the event' style="background-color:transparent;">
					  <br><input required name='EventLocation' class='form-control share-text' type="text" placeholder='Location of the event' style="background-color:transparent;">
                      <br><input required class='form-control' type='date' name='EventDate' placeholder="Event Date dd/mm/yyyy" style="background-color:transparent;">
                      <br><input required class='form-control' type='time' name='EventTime' placeholder='Event Time - 24 hour format - HH:MM' style="background-color:transparent;">
					  <input type="hidden" name="EventAdmin" value='<%=user.name%>'>
					  <br>Post Type: <select name='EventType'>
                          <option value='Sport'>Social</option>
                          <option value='Sport'>Professional</option>
                         
                          </select>
					    <center><button class='btn btn-primary'><i class='fa fa-check-circle-o'></i> Submit </button></center>
					</ul><br>
