      ...
      <a href='index.html' class='dropdown-toggle user' data-toggle='dropdown'>
        ...
        <div class='st-content-inner'>
		  ...
		  <%
					...
					eList=MySqlDataStoreUtilities.getEvents(user.name);
					ArrayList<String> userList = new ArrayList<String>();
					%>
		  <div>
				<form action="CreateEvent.jsp" method="post"><button class="btn btn-primary"><b>Create Post</b> <i class="fa fa fa-plus-circle"></i></button></form>
				<br>
				...
				uList=MySqlDataStoreUtilities.getEventsAttended(user.name);
				%>

				<div class="timeline-block">
                  <div class="panel panel-default event">
                    <div class="panel-heading title">
                     <center> <b>Events Attending:</b> </center>
                    </div>
					</div>
					</div>
				<br>
			  ...
			  <!--<button class="btn btn-success" style="background-color:#26a69a; border-color:transparent">
					<div class="panel-heading title">
						  <a href="CreateEvent.jsp" style="color:white;"><b>Create Post</b> <i class="fa fa fa-plus-circle"></i></a>
						</div>
				</button>-->
			  </div>
		   </div>
