...
<%
    ...
    if(session!=null)
    {
        ...
        friendList = MySqlDataStoreUtilities.getFriends(searchedUserEmail);
      ...
      <div class='cover-info'>
       ...
       <img src='images/<%= searchedUser.profilepic %>' />
        ...
        <ul class='cover-nav'>
          ...
          <li class='active'><a href='PublicFriends.jsp?searchedUser=<%= searchedUser.email %>'><i class=''></i> Friends</a></li>
