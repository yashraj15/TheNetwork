...
<body>
	...
	<div class="panel panel-default text-center">
		<div class="panel-body">
			...
			<p>
			<h3>Enter the file Id :</h3>
			<form id='read' action="ReadServlet" method="post">
				<input type="number" class="form-control" name="fileId" /> <br />
				<button class="btn btn-primary">
					Read File <i class="fa fa-fw fa-share-square-o"></i>
				</button>
			</form>
		</div>
	</div>
	...
	<!-- Footer -->
	<footer class="footer"> <strong>The Network</strong> &copy;
